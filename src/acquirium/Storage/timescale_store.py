        ...
        if recreate:
            ...
            with self.conn.cursor() as cur:
                ...
                for tbl in (
                    ...
                    "materialization_effect_intents",
                    "materialization_service_hints",
                    "materialization_services",
                    "experiment_run_outputs",
                    "experiment_run_artifacts",
                    "experiment_run_metrics",
                    "experiment_runs",
                    "materialization_state_revisions",
                    "materialization_artifact_requests",
                    "materialization_artifacts",
                    "materialization_definitions",
                    "topology_epoch_work",
                    "topology_epoch_outputs",
                    "topology_epoch_claims",
                    "topology_epoch_binding_pins",
                    "topology_epoch_bindings",
                    "topology_epoch_edges",
                    "topology_epoch_components",
                    "topology_epoch_retirements",
                    "topology_binding_frontiers",
