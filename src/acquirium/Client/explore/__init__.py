...
from acquirium.Client.explore.attributes import REGISTRY, Attr, Not, Registry, normalize_value
...
from acquirium.Client.explore.hidden import hidden_predicates, hidden_prefixes, hide, unhide
...
__all__ = [
    "Attr", "Not", "Query", "REGISTRY", "Registry", "RELATIONS",
    "DOWNSTREAM_EQUIPMENT", "DOWNSTREAM_PROPERTY",
    "UPSTREAM_EQUIPMENT", "UPSTREAM_PROPERTY",
    "compile_sparql", "hidden_predicates", "hidden_prefixes", "hide", "normalize_value", "unhide",
